...
(defclass sparse-character-input-stream (fundamental-character-input-stream)
...
(defmethod initialize-instance :after ((stream sparse-character-input-stream)
...
(defmethod stream-read-char ((stream sparse-character-input-stream))
  (cond
    ((current-range stream)
     (prog1
         (handler-case (read-char (underlying-stream stream))
           (end-of-file ()
...
(defmethod stream-read-sequence ((stream sparse-character-input-stream)
